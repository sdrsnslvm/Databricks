...
-- MAGIC %python
-- MAGIC dbutils.widgets.text("external_location", 'abfss://unity-catalog-storage@dbstoragegmopbeihhrebu.dfs.core.windows.net/7405609882978788/external_storage')
